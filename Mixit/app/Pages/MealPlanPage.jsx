          ...
          <View style={{ flexDirection: 'row', gap: 4 }}>
            <TouchableOpacity onPress={() => navigation.navigate('Groceries')}>
              <View style={{ backgroundColor: theme.lightGreen, borderRadius: 20, padding: 4 }}>
                <Ionicons name="cart" size={28} color={theme.primaryGreen} />
              </View>
            </TouchableOpacity>
              ...
              {!selectedDayForManagement ? (
                ...
                <View>
                  ...
                  <ScrollView style={{ maxHeight: 400 }}>
                    {days.map((day) => {
                      const dayRecipes = getRecipesForDay(day);
                      const recipeCount = dayRecipes.length;
                      return (
                        <TouchableOpacity
                          key={day}
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <ScrollView style={{ flex: 1 }}>
                    {(() => {
                      const dayRecipes = getRecipesForDay(selectedDayForManagement);
                      return (
                        <View>
                          <Text style={{ fontSize: 16, fontWeight: '600', color: theme.primaryText, marginBottom: 12 }}>
                            Recipes ({dayRecipes.length} total)
                          </Text>
                          ...
                          {dayRecipes.length > 0 ? (
                            dayRecipes.map((recipe, index) => (
                              ...
                              >
                                ...
                                <TouchableOpacity
                                  onPress={() => removeRecipeFromDay(selectedDayForManagement, index)}
                                  style={{
